...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const cspDirectives = [
      ...
      "connect-src 'self' https://api.razorpay.com https://checkout.razorpay.com https://*.razorpay.com https://api.cloudinary.com https://res.cloudinary.com https://kiitbites-backend.onrender.com" + (isProduction ? "" : " http://localhost:* ws://localhost:*"),
