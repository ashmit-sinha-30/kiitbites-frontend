...
export default function Error({
    ...
    useEffect(() => {
        // Scroll reveal functionality for the error page
            ...
            <div className="container mx-auto px-4 relative z-10 flex flex-col items-center justify-center text-center">
                <div className="reveal">
                    <div className="flex justify-center mb-6">
                        <div className="w-24 h-24 bg-white/60 backdrop-blur-sm rounded-full flex items-center justify-center shadow-xl border border-white/50 animate-float text-red-500">
                    ...
                    <p className="text-lg md:text-xl text-gray-700 mb-10 max-w-lg mx-auto leading-relaxed bg-white/40 backdrop-blur-sm p-4 rounded-xl border border-white/50">
                        We&apos;re sorry, an unexpected error has occurred. Please try again or head back to the home page.
                    </p>

                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Button
                            onClick={() => reset()}
                            className="bg-white hover:bg-gray-100 text-[#01796f] border-2 border-[#01796f] px-8 py-6 rounded-lg text-lg font-semibold shadow hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2"
                        >
                        ...
                        <Button
                            asChild
                            className="bg-gradient-to-r from-[#0e6e6e] to-[#01796f] hover:from-[#0a5858] hover:to-[#025e57] text-white px-8 py-6 rounded-lg text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
                        >
                            <Link href="/">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
