...
export const metadata: Metadata = {
  title: "OTP Verification - Secure Your KAMPYN Account",
  description: "Verify your KAMPYN account with a secure OTP. Complete the verification process to ensure the security of your account and continue using our campus food ordering services.",
  robots: {
    index: false,
    follow: true,
  },
